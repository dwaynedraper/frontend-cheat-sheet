    ...
    <div className="bg-white dark:bg-gray-900 w-screen py-20">
      <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center justify-center space-y-8 lg:-mx-4 lg:flex-row lg:items-stretch lg:space-y-0">
          <PriceCard tier="Free" price="-" benefits={['Free forever', 'Basic UI Components', 'Cheat Sheets']} buttonText="Join now" />
          <PriceCard tier="Basic" price="$3" benefits={['Layout Templates', 'Custom Themes', 'Composite Components']} buttonText="Join now" />
